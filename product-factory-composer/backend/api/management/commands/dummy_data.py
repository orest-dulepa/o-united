...
class Command(BaseCommand):
        ...
        tasks = [
            {
                ...
                "detail_url": "https://github.com/OU/product-factory/issues/7",
                "capability": "Post",
                "status": 0,
                "created_by": users[0],
                "updated_by": users[0]
            },
            {
                ...
                "detail_url": "https://github.com/OU/product-factory/issues/8",
                "capability": "Post",
                "status": 1,
                "created_by": users[1],
                "updated_by": users[1]
            },
            {
                ...
                "detail_url": "https://github.com/OU/product-factory/issues/4",
                "capability": "Post",
                "status": 2,
                "created_by": users[0],
                "updated_by": users[0]
    ...
    def create_matches(self, users):
        ...
        for task in tasks:
            ...
            TaskDeliveryAttempt.objects.get_or_create(task=task,
                                                   person=person,
                                                   kind=1)
    ...
    def create_product_persons(self, users, products):
        Person.objects.get_or_create(product=products[0],
                                            person=users[0],
                                            right=2)
