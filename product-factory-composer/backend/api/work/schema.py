...
from api.work.utils import get_tasks, get_tasks_by_product, get_task_category_listing, get_categories
...
class TaskCategoryQuery(ObjectType):
    ...
    def resolve_task_category_listing(info, *args, **kwargs):
        return get_task_category_listing(TaskCategoryList, info, *args, **kwargs)

    @staticmethod
    def resolve_categories(info, *args, **kwargs):
        return get_categories(TaskCategoryList, info, *args, **kwargs)
