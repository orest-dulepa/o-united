...
class TaskType(DjangoObjectType):
    ...
    task_expertise = graphene.String()
    ...
    def resolve_task_expertise(self, _):
        return self.category.expertise if self.category else None
...
class TaskListingType(DjangoObjectType):
    ...
    def resolve_category(self, info):
        return self.task.category.category if self.task.category else None

    def resolve_expertise(self, info):
        return self.task.category.expertise if self.task.category else None
